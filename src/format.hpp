 ...
 *      the placeholder "{}" can be escaped by using double brackets "{{}}".
 */
#define NTT_FORMAT_TYPE_VECTOR_DECLARE(type) \
    String format(const String &formatMsg, const std::vector<type> &value);

    NTT_FORMAT_TYPE_VECTOR_DECLARE(u8);
    NTT_FORMAT_TYPE_VECTOR_DECLARE(i8);
    NTT_FORMAT_TYPE_VECTOR_DECLARE(u16);
    NTT_FORMAT_TYPE_VECTOR_DECLARE(i16);
    NTT_FORMAT_TYPE_VECTOR_DECLARE(u32);
    NTT_FORMAT_TYPE_VECTOR_DECLARE(i32);
    NTT_FORMAT_TYPE_VECTOR_DECLARE(u64);
    NTT_FORMAT_TYPE_VECTOR_DECLARE(i64);
    NTT_FORMAT_TYPE_VECTOR_DECLARE(f32);
    NTT_FORMAT_TYPE_VECTOR_DECLARE(f64);

    NTT_FORMAT_TYPE_VECTOR_DECLARE(String);
    NTT_FORMAT_TYPE_VECTOR_DECLARE(bool);
